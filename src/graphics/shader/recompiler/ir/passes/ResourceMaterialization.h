...
// Last MaterializeResources failure for the calling thread. Empty if the last call succeeded.
// Combines the SRT walk reason with the specialization reason for log correlation.
